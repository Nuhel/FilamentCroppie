<x-dynamic-component
    ...
    <div class="relative" x-data="{
        ...
        @php
            $uniquemodalevent = \Illuminate\Support\Str::of($getStatePath())
                ->replace('.', '')
                ->replace('_', '');
        @endphp
    ...
    <div x-data="{ files: null, }" @on-croppie-modal-show-{{ $uniquemodalevent }}.window="
        ...
        <x-filament::modal
            ...
            <div class="z-5 flex h-full w-full flex-col justify-between"
                ...
                <div class="h-full w-full" wire:ignore>
                    ...
                    <div class="relative h-full w-full">
                        <div x-on:click.prevent class="h-full bg-transparent">
                            ...
                            <div class="flex justify-center gap-2 pb-2">
                                ...
                                @if ($isLeftRotationEnabled())
                                    <x-filament::button class="px-2" type="button" x-on:click.prevent="rotateLeft()">
                                        <svg class="filament-button-icon h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6">
                                ...
                                @if ($isRightRotationEnabled())
                                    <x-filament::button type="button" x-on:click.prevent="rotateRight()">
                                        <svg style="transform: scale(-1,1)" class="filament-button-icon h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 15l-6 6m0 0l-6-6m6 6V9a6 6 0 0112 0v3" />
                                        </svg>
                                    </x-filament::button>
                                @endif
                        ...
                        <div x-show="!showCroppie" class="absolute top-0 left-0 z-10 flex h-full w-full items-center justify-center bg-white">
